...
const ChunkManagementSystem = preload("res://scripts/stage/components/ChunkManagementSystem.gd")
const ContentDistributionSystem = preload("res://scripts/stage/components/ContentDistributionSystem.gd")
const StageConfigSystem = preload("res://scripts/stage/components/StageConfigSystem.gd")
...
func _on_stage_generation_requested(config: StageCompositionConfig, game_mode: String) -> void:
    ...
    # Emit stage ready signal
    GlobalSignals.stage_ready.emit(config)
